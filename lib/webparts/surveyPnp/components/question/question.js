...
var Question = function (props) {
    ...
    var _g = React.useState(''), year = _g[0], setYear = _g[1];
    var _h = React.useState(''), month = _h[0], setMonth = _h[1];
    var _j = React.useState([{ ID: 1, Title: 'C#' },
        { ID: 2, Title: 'Java' },
        { ID: 3, Title: 'PHP' },
        { ID: 4, Title: 'Python' },
        { ID: 5, Title: 'R' }]), option = _j[0], setOption = _j[1];
    var _k = React.useState(""), Ans1 = _k[0], setAns1 = _k[1];
    var _l = React.useState([]), Ans2 = _l[0], setAns2 = _l[1];
    var _m = React.useState(""), Ans3 = _m[0], setAns3 = _m[1];
    var _o = React.useState(""), Ans4 = _o[0], setAns4 = _o[1];
    ...
    var handleRating = function (e, rating) {
        setAns4("".concat(rating.toString(), " stars"));
        console.log(Ans4);
    };
    var submitSurvey = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, submit(props.context, props.context.pageContext.user.email, props.context.pageContext.user.displayName, true, Ans1, Ans2.toString(), Ans3, Ans4)];
                case 1:
                    _a.sent();
                    setComplete(true);
                    setQues4(false);
        ...
        ques2 &&
            (React.createElement("div", null,
                React.createElement("div", { className: styles.item },
                    ...
                    React.createElement("div", null, option.map(function (item, index) {
                        return (React.createElement(Checkbox, { key: index, label: item.Title, title: item.Title, onChange: handleCheckBox }));
                    }))),
